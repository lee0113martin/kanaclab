<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="books.aspx.vb" Inherits="ACC_DB.books" %>
    ...
    <form id="form1" runat="server"  >
        <center>
            ...
            <asp:Panel ID="Panel2" runat="server" Height="593px" HorizontalAlign="Center" Width="969px" BackColor="#0099CC">
                <br />
                <br />
                <asp:Image ID="Image1" runat="server" Height="100px" ImageAlign="Middle" ImageUrl="~/R.png" Width="111px" />
                <br />
                <br />
                ...
                &nbsp;&nbsp;<asp:Button ID="Button3" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" Height="36px" Text="EDIT" Width="96px" />
                ...
                &nbsp; &nbsp;
                <br />
                <asp:GridView ID="PARENTGV0" runat="server" AllowCustomPaging="True" AllowSorting="True" AutoGenerateColumns="False" BorderStyle="None" Caption="ALUMIN CENTER" CaptionAlign="Top" CellPadding="1" Font-Size="Medium" ForeColor="#333333" Height="156px" HorizontalAlign="Center" PageSize="63" RowHeaderColumn="Center" style="text-align: center; font-weight: 700; font-size: medium; font-family: 'Times New Roman'; color: #000000; background-color: #FFFFFF" Visible="False" Width="948px">
